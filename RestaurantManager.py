...
def create_invoice():
    ...
    invoice_text.insert(END, f'*' * 58 + '\n')
    invoice_text.insert(END, f'Items\t\tQuantity\tItems Cost\n')
    invoice_text.insert(END, f'-' * 70 + '\n')
...
# Top panel
top_panel = Frame(application, bd = 1, relief = RIDGE)
top_panel.pack(side = TOP)

# Title tag
title_tag = Label(top_panel, text = "Invoicing System", fg = "azure4",
                        font = ("Dosis", 50), bg = "white", width = 27 )
